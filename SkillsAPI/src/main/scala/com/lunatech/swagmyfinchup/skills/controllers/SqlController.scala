...
object SqlController {
  ...
  def createDatabase =
    db.run(
      DBIO.seq(
        skills.schema.create,
        skills += Skill(UUID.fromString("4b423060-2611-4f60-9a8c-73356da53661"),
                        "Scala",
                        "Programming"),
        skills += Skill(UUID.fromString("4f6cff39-885e-4a8b-a672-ade70b1e8251"),
                        "Java",
                        "Programming"),
        skills += Skill(UUID.fromString("f9eb40e9-8c90-49cd-bb5a-9272e878de9b"),
                        "Play",
                        "Programming"),
        skills += Skill(UUID.fromString("5ae06d68-790c-4517-af64-94c9bc2f0495"),
                        "Finch",
                        "Programming"),
        skills += Skill(UUID.fromString("d28c6de3-5cdf-4a7c-b4e5-7b8ec1827de3"),
                        "Finagle",
                        "Programming"),
        ...
        skills += Skill(UUID.fromString("83c98340-0998-4c4a-b336-a520b9a2285a"),
                        "Elastic Search",
                        "DB"),
        skills += Skill(UUID.fromString("864ba165-8b89-41df-b533-d7016400b2b0"), "Cassandra", "DB"),
        skills += Skill(UUID.fromString("990e52d9-13c7-4291-b643-e54c0ac284cd"),
                        "Finatra",
                        "Programming"),
        skills += Skill(UUID.fromString("5e491153-839d-4e73-8d28-0cc9406db4d4"),
                        "Swagger",
                        "Documenting")
      ))
