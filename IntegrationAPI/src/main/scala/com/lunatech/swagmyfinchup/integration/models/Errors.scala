...
final case class CreationException(modelName: String, cause: String) extends SMFUEerror {
...
final case class ReadException(modelName: String, cause: String) extends SMFUEerror {
...
final case class UpdateException(modelName: String, cause: String) extends SMFUEerror {
  override def getMessage: String = s"Could not update $modelName. Cause: $cause"
  override def internalCode: Int  = 3
  override def httpCode: Int      = 500
}

final case class DeleteException(modelName: String, cause: String) extends SMFUEerror {
  override def getMessage: String = s"Could not delete $modelName. Cause: $cause"
  override def internalCode: Int  = 4
  override def httpCode: Int      = 500
}

final case class ListException(modelName: String, cause: String) extends SMFUEerror {
  override def getMessage: String = s"Could not list $modelName. Cause: $cause"
  override def internalCode: Int  = 5
  override def httpCode: Int      = 500
}

final case class ParseException(modelName: String, cause: String) extends SMFUEerror {
